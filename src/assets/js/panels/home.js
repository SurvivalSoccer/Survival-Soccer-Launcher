...
class Home {
    ...
    initBtn() {
        ...
        document.querySelector('.Youtube').addEventListener('click', () => {
            this.openlink('https://www.youtube.com/channel/UC-y0T7aE9ZLn7B3Ei6cJpYQ');
        })
        document.querySelector('.Youtube').addEventListener('click', () => {
            this.openlink('https://www.youtube.com/c/WOLFLEVRAI');
        })
        document.querySelector('.Twitch').addEventListener('click', () => {
            this.openlink('https://twitch.tv/flpkay');
        })
        document.querySelector('.Website').addEventListener('click', () => {
            this.openlink('https://survivalsoccer.glitch.me');
        })
    }
